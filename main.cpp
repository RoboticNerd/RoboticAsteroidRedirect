...
int main() 
{
	...
	cout << "velocity of arrival ellipse perigee        : " << v_p_f << " km/s" << endl;

	double v_inf_f = abs(v_p_f - v_earth);
	cout << "parking circular velocity                  : " << v_inf_f << " km/s" << endl;

	double d_v_final = d_v_circle(v_final, v_inf_f);						// km/s 	dV needed to park in earth orbit
	cout << "Arrival burn into parking orbit dV         : " << d_v_final << " km/s" << endl;
	...
	cout << "Velocity of asteroid circular orbit        : " << v_asteroid << " km/s" << endl;

	double v_a_3 = v_ellipse(u_sun, aaa, r_orb_asteroid);			// km/s  apogee departure velocity
	cout << "velocity of departure ellipse at apogee    : " << v_a_3 << " km/s" << endl;

	double d_v_3 = abs(v_asteroid - v_a_3);							// km/s  dV 3rd burn
	cout << "dV of burn to move asteroid into ellipse   : " << d_v_3 << " km/s" << endl;
	...
	cout << "Apogee velocity of arriving elipse         : " << v_a_2 << " km/s" << endl;

	double d_v_2 = abs(v_asteroid - v_a_2);									// km/s  dV 3rd burn
	cout << "d_V of burn to join asteroid orbit         : " << d_v_2 << " km/s" << endl;
